...
class ProjectRolesControllerTest < ActionController::TestCase
  ...
  test "should create project_role" do
    assert_difference('ProjectRole.count') do
      post :create, project_role: { invite_num: @project_role.invite_num, project_id: @project_role.project_id, role_id: @project_role.role_id, user_id: @project_role.user_id }
    end
  ...
  test "should update project_role" do
    patch :update, id: @project_role, project_role: { invite_num: @project_role.invite_num, project_id: @project_role.project_id, role_id: @project_role.role_id, user_id: @project_role.user_id }
    assert_redirected_to project_role_path(assigns(:project_role))
  end
