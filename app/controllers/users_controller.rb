class UsersController < ApplicationController
  ...
  # POST /users.json
   def create
    ...
    if @user.save
      ...
      redirect_to home_path, notice: "Thank you for creating an account!"
    else
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:f_name, :l_name, :email, :username, :active, :phone, :password, :password_confirmation)
    end
